const config = {
  ...
  COMPARISON_OPTIONS: {
    threshold: 0.1, // 10% pixel threshold
  ...
  // Mask regions whose rendering depends on the host's font hinting/subpixel
  // pipeline (H/M/S text labels). Pixel-equivalent across machines without
  // requiring the OS-level font configuration to match CI.
  CYPRESS_SCREENSHOT_OPTIONS: {
    blackout: [".actual-label"],
  },
